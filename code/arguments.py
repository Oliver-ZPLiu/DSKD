...
def add_runtime_args(parser: argparse.ArgumentParser):
    ...
    group.add_argument("--on-policy-after-epoch", type=int, default=1)
    group.add_argument("--on-policy-refresh-epochs", type=int, default=1)
...
def add_gen_args(parser: argparse.ArgumentParser):
    ...
    group.add_argument("--on-policy-top-k", type=int, default=0)
    group.add_argument("--on-policy-top-p", type=float, default=0.9)
    group.add_argument("--on-policy-do-sample", action="store_true")
    group.add_argument("--on-policy-temperature", type=float, default=1.0)
